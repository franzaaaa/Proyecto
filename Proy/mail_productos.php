 ...
 */
$mail->Subject = utf8_decode("Pedido Online");
$texto =utf8_decode( '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Compra</title><meta charset = "UTF-8"></head><body>	
    <h2>Hola '.$_SESSION["email"].', acabamos de recibir tu pedido<h2><br>'.mostrar(getProd($productos)).'</body>
</html>');
// cuerpo
$mail->MsgHTML($texto);
/*
